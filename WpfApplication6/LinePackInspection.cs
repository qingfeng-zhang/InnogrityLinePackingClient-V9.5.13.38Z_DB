...
namespace BCReader
{
    ...
    //    #endregion
            ...
            try
            {
                ...
                switch (labeltype)
                {
                    ...
                    case 2: //INTEL TYPE
                        ...
                        int[] bcstep2 = { 7, 9, 13, 18, 22, 26, 30, 34, 38, 52 };
                        ...
                        #endregion
                        #region OCR for intel Boxtype
                        int[] ocrstep2 = { 6, 8, 12, 17, 21, 25, 29, 33, 37, 51 };
        ...
        public int IntelLabelCheck(string zplfilepath)
        {
            ...
            //int box3pos = zplfilepath.IndexOf("STEK");
            //int intelpos = -1;
        ...
        public void spektek2(bool SpektekOn, bool IntelOn)
        {
            ...
            if (SpektekOn)//border for spektek
            {
                linepackomronsystem.UnitData_Change(92, 121, Speklefmin);
                linepackomronsystem.UnitData_Change(92, 120, Speklefmax);
                linepackomronsystem.UnitData_Change(92, 123, Spekritemin);
                linepackomronsystem.UnitData_Change(92, 122, Spekritemax);
                linepackomronsystem.UnitData_Change(92, 125, Spektopmin);
                linepackomronsystem.UnitData_Change(92, 124, Spektopmax);
                linepackomronsystem.UnitData_Change(92, 127, Spekbtmmin);
                linepackomronsystem.UnitData_Change(92, 126, Spekbtmmax);
            }
            else if (IntelOn)//border for intel
            {
                linepackomronsystem.UnitData_Change(92, 121, Intlefmin);
                linepackomronsystem.UnitData_Change(92, 120, Intlefmax);
                linepackomronsystem.UnitData_Change(92, 123, Intritemin);
                linepackomronsystem.UnitData_Change(92, 122, Intritemax);
                linepackomronsystem.UnitData_Change(92, 125, Inttopmin);
                linepackomronsystem.UnitData_Change(92, 124, Inttopmax);
                linepackomronsystem.UnitData_Change(92, 127, Intbtmmin);
                linepackomronsystem.UnitData_Change(92, 126, Intbtmmax);
            }
            else //border for other
            {
                linepackomronsystem.UnitData_Change(92, 121, pleftmin);              //Left
                linepackomronsystem.UnitData_Change(92, 120, plefmax);
                linepackomronsystem.UnitData_Change(92, 123, pritmin);            //Right
                linepackomronsystem.UnitData_Change(92, 122, pritemax);
                linepackomronsystem.UnitData_Change(92, 125, ptopmin);          //TOp
                linepackomronsystem.UnitData_Change(92, 124, ptopmax);
                linepackomronsystem.UnitData_Change(92, 127, pbtmmin);            //bottom
                linepackomronsystem.UnitData_Change(92, 126, pbtmmax);
            }
        }
