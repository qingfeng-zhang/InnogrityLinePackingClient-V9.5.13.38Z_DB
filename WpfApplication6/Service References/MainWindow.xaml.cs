        ...
        private void OpSceen(Boolean posScr)
        {
            ...
            if (posScr)
            {
                if (sc.Length > 1)
                {
                    ...
                    op1win.WindowStartupLocation = System.Windows.WindowStartupLocation.CenterScreen;
                }
                ...
                if (sc.Length > 2)
                {
                    ...
                    op2win.WindowStartupLocation = System.Windows.WindowStartupLocation.CenterScreen;
                }
            }
            else
            {
